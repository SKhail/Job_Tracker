...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(next_page='login'), name='login'), # login path 
    path('logout/', auth_views.LogoutView.as_view(next_page='logout'), name='logout'), # logout path
    path('register.html', views.register, name='register'), # Register path 
]